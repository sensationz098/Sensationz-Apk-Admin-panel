export default function HomePage() {
  return (
    <main className="page-wrapper bg-[#0a0a0a] text-gray-200 flex flex-col items-center justify-center p-10">
      <section className="text-center max-w-3xl">
        <h1 className="text-5xl font-bold text-white mb-4 tracking-tight mt-44">
      ...
      <footer className="mt-20 text-center text-sm text-gray-600 mt-72">
